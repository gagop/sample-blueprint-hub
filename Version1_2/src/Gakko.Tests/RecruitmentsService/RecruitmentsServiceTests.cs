...
public class RecruitmentsServiceTests
{
    ...
    private readonly API.Recruitment.RecruitmentsService _service;
    ...
    public RecruitmentsServiceTests()
    {
        ...
        _service = new API.Recruitment.RecruitmentsService(_dbContext, appointmentService, emailService);
    }
